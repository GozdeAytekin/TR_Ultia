...
namespace Ultia.MyProvider
{
    public class MSSQLProvider
    {
        ...
        public MSSQLProvider(string cmdText, string appConnectionString = "server=.;Database=AssetDB;Integrated Security = True")
        {
            conn = new SqlConnection(appConnectionString);
            cmd = new SqlCommand(cmdText, conn);
        }

        public MSSQLProvider(string cmdText, CommandType type, SqlTransaction tran, string appConnectionString = "server=.;Database=AssetDB;Integrated Security = True")
        {
            conn = new SqlConnection(appConnectionString);
        ...
        public MSSQLProvider(string[] cmdText, List<SqlParameter[]> myParameters, SqlTransaction tran, string appConnectionString = "server=.;Database=AssetDB;Integrated Security = True")
        {
            conn = new SqlConnection(appConnectionString);
            try
            {
